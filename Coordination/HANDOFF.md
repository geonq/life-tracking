...
Latest feature checkpoints: CP-B B at 09f5575 and simulator selector at 596077d;
local/origin parity was verified after the selector push. CP-B A and B are complete;
...
resolved. Selector fix 596077d has Astra GO; 20 focused tests and the actual
full simctl pipeline pass, selecting the iOS 27 iPhone 17. No simulator was
booted. The broad iOS logic lane still needs a full iOS 27 rerun.
...
1. Repair the Planning fixture and stale assertions; investigate picker
   dismissal, then rerun focused and full iOS logic lanes on iOS 27.
