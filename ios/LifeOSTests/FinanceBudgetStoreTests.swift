...
final class FinanceBudgetStoreTests: XCTestCase {
    ...
    private func transaction(category rawCategory: FinanceTransactionCategory, cents: Int, daysAgo: Int = 0) -> FinanceImportedTransaction {
        ...
        case .health: description = "Apotheke"
        case .travel: description = "Hotel"
        case .transfers: description = "Bank transfer"
        case .fees: description = "Bank fee"
        case .taxes: description = "Finanzamt"
        case .investments: description = "Trade Republic"
