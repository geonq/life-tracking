...
Assert-Text 'S-1-5-18</UserId><LogonType>ServiceAccount' 'The snapshot task runs as the SYSTEM service account.'
...
Assert-Text 'restoreParent = Split-Path -Parent \$destination' 'Tree ACL rollback restores from the saved root parent.'
